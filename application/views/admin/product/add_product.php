                                    ...
                                    <div class="card-body">
                                        <?php $this->load->view('admin/msg'); ?>
                                         <?php 
                                            ...
                                            echo form_open_multipart('product/insert_product',$formData); 
                                        ?>
                                            <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group ">
                                                            <h5>Product Name <code>*</code></h5>
                                                            <div class="controls">
                                                                <input type="text" name="product_name" class="form-control mb-1" required data-validation-required-message="This field is required" placeholder="Product Name">
                                                            </div>
                                                        </div>
                                                    </div> 
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <h5>Main Category <code>*</code> <a href="<?= base_url()?>category">(Add Main Category)</a></h5>
                                                            <div class="controls">
                                                   ...
                                                   <!--  <div class="col-md-3">
                                                        <div class="form-group">
                                                        <h5>Sub Category <code>*</code><a href="<?= base_url()?>subcategory">(Add Sub Category)</a></h5>
                                                            <div class="controls">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <h5>Product Image: <span class="required">*</span></h5>
                                                            <div class="controls">
                                                                <input type="file" name="product_img" id="img" class="form-control mb-1" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group ">
                                                            <h5>Reguler Price: <span class="required">*</span></h5>
                                                            <div class="controls">
                                                                <input type="text" name="reguler_price" class="form-control mb-1" required data-validation-required-message="This field is required" placeholder="Reguler Price">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group ">
                                                            <h5>Discount Price: <span class="required">*</span></h5>
                                                            <div class="controls">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group ">
                                                            <h5>Discount Percentage: <span class="required">*</span></h5>
                                                            <div class="controls">
                                                                <input type="text" name="discount_percentage" class="form-control mb-1"  placeholder="Discount Percentage">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group ">
                                                            <h5>Discount Validity: <span class="required">*</span></h5>
                                                            <div class="controls">
                                                                <input type="date" name="discount_date" class="form-control mb-1" required data-validation-required-message="This field is required" placeholder="Discount Validity">
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="row">
                                                    <div class="col-md-12">
                                                       <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <textarea cols="30" rows="10" name="details" id="details" class="form-control mb-1" required placeholder="product Details"></textarea>
                                                        </div>
                                                    </div>
                                                    </div>
                                            </div>
