                        ...
                        <div class="row product-grid margin-50px-bottom sm-margin-30px-bottom">
                            ...
                            <div class="col-xl-3 col-md-6 margin-30px-bottom sm-margin-20px-bottom">
                                <div class="border">
                                    ...
                                    <a href="<?php base_url();echo $product->category?>/<?php echo $product->project ?>" class="product-block">
                                        <img src="https://picsum.photos/200" alt="" style="height: 220px;width: 100%" /></a>
