            ...
            <div class="container">
                <div class="row">
                 ...
                 <div class="col-md-3 margin-30px-bottom xs-margin-20px-bottom mt-4">
                        ...
                        <p class="text-center no-margin pt-3">146 quality checks</p>
                    </div>
                 </div> 
                        ...
                        <div class="border">
                            ...
                            <div class="product-info">
                                ...
                                <p class="price text-center no-margin">
                                    ...
                                    <span><del>৳<?= number_format($product->reguler_price) ?></del></span>
                                    <?php } else { ?><span>৳<?= number_format($product->reguler_price) ?></span><?php } ?>
                                    <?php if ($product->discount_price>0) { ?>
                                    <span style="color:red;">৳<?= number_format($product->discount_price) ?></span><?php } ?>

                                    <?php if ($product->discount_percentage!='') { ?>
                                    <span style="color:orange;">
                                        <font size="2"><?= $product->discount_percentage ?> off</font>
                                    </span><?php } ?>
                                </p>
                            </div>
                            <!-- <div class="buttons">
